...
%--------------------------------------------------------------------------
function varargout = GUI_ControlPanel2D(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GUI_ControlPanel2D_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_ControlPanel2D_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GUI_ControlPanel2D_OpeningFcn(hObject, ~, handles, varargin)
...
function varargout = GUI_ControlPanel2D_OutputFcn(~, ~, handles)
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if npanels == 4
        fig1 = GUI_visualize_v4;        
        %Write up the z-scale in all the panels
        handles = guihandles(fig1);
        GUI_visualize_v4('showupvalues',fig1,handles);        
    else
        fig1 = GUI_visualize_v2;
        %Write up the z-scale in all the panels
        handles = guihandles(fig1);
        GUI_visualize_v2('showupvalues',fig1,handles);        
    end
